...
public class TestCreate extends ClassLoader implements Opcodes {
	...
	public void test(){
		...
		try {
			code = dump( );
			Class< ? > exampleClass = this.defineClass( "test" , code , 0 , code.length ) ;
		} catch ( Exception e ) {
			// TODO 自动生成的 catch 块
			e.printStackTrace();
		}
	...
	public static byte[ ] dump( ) throws Exception {
		...
		cw.visit( 52 , ACC_PUBLIC + ACC_SUPER , "com/lamp/ledis/entity/TestEntityKeyCreate" ,
				"Lcom/lamp/ledis/create/AbstractKeyCreate<Lcom/lamp/ledis/entity/TestEntity;>;" ,
				"com/lamp/ledis/create/AbstractKeyCreate" , null );

		cw.visitSource( "TestEntityKeyCreate.java" , null );

		{
			...
			Label l2 = new Label( );
			mv.visitLabel( l2 );
			mv.visitLocalVariable( "this" , "Lcom/lamp/ledis/entity/TestEntityKeyCreate;" , null , l0 , l2 , 0 );
		...
		}
		{
			...
			mv.visitMethodInsn( INVOKEVIRTUAL , "com/lamp/ledis/entity/TestEntityKeyCreate" , "getKey" ,"(I)Ljava/lang/String;" , false );
			mv.visitInsn( ARETURN );
			Label l1 = new Label( );
			mv.visitLabel( l1 );
			mv.visitLocalVariable( "this" , "Lcom/lamp/ledis/entity/TestEntityKeyCreate;" , null , l0 , l1 , 0 );
		...
		}
		{
			...
			mv.visitMethodInsn( INVOKEVIRTUAL , "com/lamp/ledis/entity/TestEntityKeyCreate" , "getKey" ,
		...
		}
		{
			...
			mv.visitMethodInsn( INVOKEVIRTUAL , "com/lamp/ledis/entity/TestEntityKeyCreate" , "getKeySuffix" ,
		...
		}
		{
			...
			mv.visitTypeInsn( CHECKCAST , "com/lamp/ledis/entity/TestEntity" );
			mv.visitVarInsn( ALOAD , 2 );
			mv.visitMethodInsn( INVOKEVIRTUAL , "com/lamp/ledis/entity/TestEntityKeyCreate" , "getKeySuffixBuffer" ,
